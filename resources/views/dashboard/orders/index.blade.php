            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <select name="client_id" class="form-control" id="">
                                            <option value="" selected disabled>@lang('site.Fo')</option>
                                            @foreach ($orders as $sections)
                                                <option value="{{ $sections->client_id }}"
                                                    {{ request()->client_id == $sections->client_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ url('dashboard/export_order') }}" class="btn btn-primary btn-sm"><i
                        ...
                        @endforeach
                        <h3>TOTAL: {{ \App\Models\Order::sum('total_price') }} MRU</h3>
