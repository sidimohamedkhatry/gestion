                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                              ...
                              <div class="form-group col-md-6" >
                                ...
                                <select name="status" id="" class="form-control " required>
                                    ...
                                    {{-- <option value="{{ $order->status }}" selected >Payé</option>  --}}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="num_fa" id="num_fa" value="{{ $order->num_fa }}" >
                                </div>
                                <table class="table table-hover">
                                    ...
                                    @foreach ($order->products as $product)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $product->name }}</td>
                                            <td><input type="number" name="products[{{ $product->id }}][quantity]" data-price="{{ number_format($product->purches_price, 2) }}" class="form-control input-sm product-quantity" min="1" value="{{ $product->pivot->quantity }}"></td>
                                            <td class="product-price">{{ number_format($product->purches_price * $product->pivot->quantity, 2) }}</td>
                                            <td>
