@extends('layouts.dashboard.hama')
@section('title')
    @lang('site.co')
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.co')
                <small>{{ $orders->count() }} @lang('site.co')</small>
            </h1>
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <form action="{{ route('dashboard.sidi.index') }}" method="get">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm order-products"
                                                    data-url="{{ route('dashboard.sidi.products', $order->id) }}"
                                                    data-method="get">
